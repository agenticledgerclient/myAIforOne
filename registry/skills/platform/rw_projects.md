...
After switching, use `rw_status` skill to see project details.
...
- **View project details**: Use `rw_status` skill
- **Create new project**: Use `rw_new` skill
- **Manage environments**: Use `rw_environment` skill
