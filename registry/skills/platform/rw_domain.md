...
Use `rw_environment` skill to see configured domains, or query directly:
...
Use `rw_environment` skill to remove domains:
...
Then use `rw_environment` skill to apply and commit the change.
...
- **Read domains**: Use `rw_environment` skill
- **Remove domains**: Use `rw_environment` skill
- **Apply removal**: Use `rw_environment` skill
- **Check service**: Use `rw_service` skill
