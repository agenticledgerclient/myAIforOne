...
$menu.Items.Add("---")
$menu.Items.Add("Start Service", $null, { schtasks /Run /TN MyAIforOneGateway })
$menu.Items.Add("Stop Service", $null, { schtasks /End /TN MyAIforOneGateway })
$menu.Items.Add("Restart Service", $null, { schtasks /End /TN MyAIforOneGateway; Start-Sleep 2; schtasks /Run /TN MyAIforOneGateway })
